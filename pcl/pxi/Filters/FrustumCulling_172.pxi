...
#        self.me.setCropOutside(<bool> False)
    ...
    def SetHorizontalFOV (self,hfov):
        self.me.setHorizontalFOV (hfov)

    def SetVerticalFOV(self,vfov):
        self.me.setVerticalFOV(vfov)

    def SetNearPlaneDistance (self,np_dist):
        self.me.setNearPlaneDistance(np_dist)

    def SetFarPlaneDistance (self,fp_dist):
        self.me.setFarPlaneDistance(fp_dist)
